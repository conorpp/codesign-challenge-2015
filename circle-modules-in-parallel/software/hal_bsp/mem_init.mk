...
MEM_0 := challengeqsys_onchip_memory2_0
...
$(MEM_0)_START := 0x00110000
$(MEM_0)_END := 0x00117ffe
$(MEM_0)_SPAN := 0x00007fff
...
# Memory: pixelmemory
MEM_1 := challengeqsys_pixelmemory
$(MEM_1)_NAME := pixelmemory
...
$(MEM_1)_START := 0x00108000
$(MEM_1)_END := 0x0010fffe
$(MEM_1)_SPAN := 0x00007fff
$(MEM_1)_HIERARCHICAL_PATH := pixelmemory
$(MEM_1)_WIDTH := 32
...
.PHONY: pixelmemory
pixelmemory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
